...
def main():
    ...
    channel.exchange_declare(exchange='test_fanout', type='fanout', durable=True, auto_delete=False)
    ...
    for i in range(30000):
        ...
        message.body += " "+ str(i)
        channel.basic_publish(msg=message, exchange='test_fanout', routing_key='')
